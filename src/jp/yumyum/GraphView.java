...
class GraphView extends View {
    ...
    private static final int MEASURE_MAX = 5;
    private static final int FORWARD_PICS = 1;
    private static final int GRAPH_MAX_WIDTH = 10000;
    ...
    protected void onDraw(Canvas canvas) {
        Log.d("GraphView", "YUM onDraw: nextValueY:" + nextValueY + " cursor:" + cursor);
        super.onDraw(canvas);
        mPaint.setColor(Color.BLUE);
        mPaint.setStrokeWidth(20);
        mCanvas.drawLine(0, 0, 500, 400, mPaint);
